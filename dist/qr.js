...
var math = __webpack_require__(372);
    ...
    _createClass(ScanQr, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_qrcode2.default, { value: URL, size: 600 }),
                _react2.default.createElement(
                    'div',
                    { className: 'btn-content' },
                    _react2.default.createElement(
                        _button2.default,
                        { type: 'primary', size: 'large', onClick: this.changeCode },
                        '\u66F4\u6362\u4E8C\u7EF4\u7801'
                    )
                )
            );
...
var PropTypes = __webpack_require__(4); // qr.js doesn't handle error level of zero (M) so we need to do it right,
// thus the deep require.


var QRCodeImpl = __webpack_require__(653);

var ErrorCorrectLevel = __webpack_require__(370);
...
var Polynomial = __webpack_require__(371);
...
var mode = __webpack_require__(369);
...
// ErrorCorrectLevel
var ECL = __webpack_require__(370);
